...
public final class FLClientHandler {
    ...
    /**
     * Stores the old player camera pitch so that it can be set addPrefix to it upon completion of preloading
     */
